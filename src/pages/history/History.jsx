...
const History = ({ typeFilter }) => {
    ...
    const fetchDocuments = async () => {
        ...
        if (error) {
            ...
            // Map DB columns back to UI expectation if needed
            // Currently UI expects: number, recipient.name (nested?), date, currency, total
            // DB has: recipient_name (snake_case). We need to map it or update render.
            // Let's map it here to avoid changing the whole render JSX below too much.
    ...
    const handleEdit = (invoice) => {
        // We need to pass the FULL structure that Editor expects
        // The fetchDocuments above did a shallow spread `...doc`.
        // Editor expects: items (jsonb), recipient { name... }, sender...
        // DB has `recipient_name`, etc.
        // We should construct the proper object for editing.
